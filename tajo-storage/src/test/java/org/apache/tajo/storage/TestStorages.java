...
public class TestStorages {
  ...
  public void testSplitable() throws IOException {
    if (splitable) {
      ...
      Appender appender = TajoStorageHandler.getFileStorageHandler(conf).getAppender(meta, schema, tablePath);
      ...
      Scanner scanner = TajoStorageHandler.getFileStorageHandler(conf).getScanner(meta, schema, tablets[0], schema);
      ...
      scanner = TajoStorageHandler.getFileStorageHandler(conf).getScanner(meta, schema, tablets[1], schema);
      assertTrue(scanner.isSplittable());
      scanner.init();
      while (scanner.next() != null) {
        tupleCnt++;
  ...
  public void testProjection() throws IOException {
    ...
    Scanner scanner = TajoStorageHandler.getFileStorageHandler(conf).getScanner(meta, schema, fragment, target);
    scanner.init();
    int tupleCnt = 0;
    Tuple tuple;
  ...
  public void testVariousTypes() throws IOException {
    ...
    Scanner scanner =  TajoStorageHandler.getFileStorageHandler(conf).getScanner(meta, schema, fragment);
    scanner.init();
  ...
  public void testSeekableScanner() throws IOException {
    ...
    FileAppender appender = (FileAppender) TajoStorageHandler.getFileStorageHandler(conf).getAppender(meta, schema,
	    tablePath);
    appender.enableStats();
    appender.init();
    int tupleNum = 100000;
    ...
    for (long offset : offsets) {
      scanner = TajoStorageHandler.getFileStorageHandler(conf).getScanner(meta, schema,
