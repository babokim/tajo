...
<div class='contents'>
  ...
  <table border="1" width="100%" class="border_table">
    <tr><td align='right' width='180px'>Status:</td><td><%=subQuery.getState(true)%></td></tr>
    ...
    <tr><td align='right'>Progress:</td><td><%=JSPUtil.percentFormat((totalProgress / numTasks))%>%</td></tr>
