...
public class TestRangeRetrieverHandler {
  ...
  public void testGet() throws Exception {
    ...
    RangeShuffleFileWriteExec idxStoreExec = new RangeShuffleFileWriteExec(sort.getPlan(), ctx, sm, sort, sort.getSchema(),
  ...
  public void testGetFromDescendingOrder() throws Exception {
    ...
    SortSpec[] sortSpecs = sort.getPlan().getSortKeys();
    RangeShuffleFileWriteExec idxStoreExec = new RangeShuffleFileWriteExec(sort.getPlan(), ctx, sm, sort,
